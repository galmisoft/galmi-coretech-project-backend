...
router.post(
  ...
  CompanyController.updateCompanyContratos
);
...
router.post(
  "/combo/productSerialNumbers",
  ComboController.listProductSerialNumbers
);
...
router.post("/combo/userTypes", ComboController.listUserTypes);
