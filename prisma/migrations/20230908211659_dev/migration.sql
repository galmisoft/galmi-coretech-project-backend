/*
  ...
  - You are about to alter the column `recuperation_percentage` on the `Run` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
