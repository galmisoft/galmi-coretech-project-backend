...
CREATE TABLE "new_Items" (
    ...
    CONSTRAINT "Items_dayPartProducts_id_fkey" FOREIGN KEY ("dayPartProducts_id") REFERENCES "DayPartProducts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO "new_Items" ("client_id", "created_At", "dayPartProducts_id", "id", "line_id", "product_id", "project_id", "serial_number", "unit_price", "updated_At") SELECT "client_id", "created_At", "dayPartProducts_id", "id", "line_id", "product_id", "project_id", "serial_number", "unit_price", "updated_At" FROM "Items";
DROP TABLE "Items";
