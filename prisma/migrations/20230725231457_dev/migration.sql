...
INSERT INTO "new_Product" ("SKU", "brand", "company_id", "created_At", "id", "line_id", "name", "serial_number", "type", "updated_At") SELECT "SKU", "brand", "company_id", "created_At", "id", "line_id", "name", "serial_number", "type", "updated_At" FROM "Product";
DROP TABLE "Product";
