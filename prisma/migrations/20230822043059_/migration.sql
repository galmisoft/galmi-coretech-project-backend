/*
  ...
  - You are about to alter the column `drill_bit_change` on the `DayPartProducts` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Boolean`.
